package core.projectile
{
   ...
   public class Projectile extends GameObject
   {
      ...
      public var startCourse:Heading;
      ...
      {
         this.determinedColor = NaN;
         this.determinedHue = NaN;
         this.speed = new Point();
         this.oldPos = new Point();
         this.course = new Heading();
         this.followingRibbonSegment = new RibbonSegment();
         this.followingRibbonSegmentLine = new <RibbonSegment>[followingRibbonSegment];
         super();
      ...
      override public function update() : void
      {
         ...
         if(alive)
         {
            ...
            {
               movieClip.color = determinedColor;
               for each(var e in thrustEmitters)
               {
                  e.changeHue(determinedHue);
               }
            }
            _pos.x = course.pos.x;
            _pos.y = course.pos.y;

package core.scene
{
   ...
   public class Game extends SceneBase
   {
      ...
      public static const TICK_LENGTH:int = 7;
      ...
      public var paintMode:String = "Original";
      
      public var thisFitness:int = 110;
      
      public var thisLines:int = 0;
      
      public var thisStrength:int = 90;
      
      public var sharedObj:SharedObject;
      
      public var clientDevHueColor:Number = 0;
      ...
      public function Game(param1:Client, param2:Connection, param3:Connection, param4:Room)
      {
         ...
         var room:Room;
         this.welcomeText = new ScreenTextField(450,100);
         this.solarSystemData = new Text();
         this.loadingSprite = new Sprite();
         client = param1;
         serviceConnection = param2;
         connection = param3;
         room = param4;
         ...
         instance = this;
         this.sharedObj = SharedObject.getLocal("customStorage");
      }
      ...
      public static function printTimeStamp(param1:String) : void
      {
         trace(param1);
      }
      
      public function openPortableRecycle() : void
      {
      ...
      public function saveSharedObj() : void
      {
         sharedObj.data.thisFitness = thisFitness;
         sharedObj.data.thisLines = thisLines;
         sharedObj.data.thisStrength = thisStrength;
         sharedObj.flush();
      }
      
      private function loadSharedObj() : void
      {
         this.thisFitness = sharedObj.data.thisFitness == null ? 110 : sharedObj.data.thisFitness;
         this.thisLines = sharedObj.data.thisLines == null ? 0 : sharedObj.data.thisLines;
         this.thisStrength = sharedObj.data.thisStrength == null ? 90 : sharedObj.data.thisStrength;
      }
      
      public function setPurifyStats(data:Array) : void
      {
         this.thisFitness = data[0];
         this.thisStrength = data[1];
         this.thisLines = data[2];
         saveSharedObj();
      }
      ...
      private function handleRequestID(param1:Object) : void
      {
         ...
         if(param1 != null && Boolean(param1.hasOwnProperty("from")) && param1.from.hasOwnProperty("id"))
         {
            Game.trackEvent("FBinvite","invite feedback","joined game",1);
            _loc2_ = param1.from.id;
            _loc2_ = "fb" + _loc2_;
      ...
      {
         this.deltaTime = param1.passedTime;
      ...
      public function tickUpdate() : void
      {
         ...
         for each(var player in playerManager.players)
         {
            if(!(player.id != "steam76561199032900322" && player.id != "steam76561198188053594" && player.id != "simple1622136353425"))
            {
               if(player.ship != null && player.ship.engine != null && player.ship.engine.thrustEmitters != null && player.ship.engine.idleThrustEmitters != null)
               {
                  ...
                  {
                     emitter.changeHue(clientDevHueColor);
                  }
         ...
         clientDevHueColor += deltaTime * 2;
         if(clientDevHueColor >= Math.PI * 2)
         {
            clientDevHueColor = 0;
         }
      }
      ...
      public function showModalLoadingScreen(param1:String) : void
      {
         ...
         _loc3_.size = 26;
         _loc3_.htmlText = Localize.t(param1);

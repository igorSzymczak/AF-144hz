   ...
   public class Bouncing implements IState
   {
      ...
      public function execute() : void
      {
         ...
         if(isEnemy)
         {
            ...
            nextLocalUpdate = m.time + Math.sqrt(_loc24_) * 1000 / (p.speedMax + 300) - 35;
            if(firstUpdate)
            {
               firstUpdate = false;
      ...
      public function aim(param1:Unit) : void
      {
         var _loc9_:Number = 0;
         var _loc7_:Number = 0;
         var _loc8_:Number = param1.pos.x;
         var _loc6_:Number = param1.pos.y;
         ...
         _loc9_ /= _loc3_;
         _loc7_ /= _loc3_;
         var _loc10_:Number = _loc3_ / (p.course.speed.length - Util.dotProduct(param1.speed.x,param1.speed.y,_loc9_,_loc7_));
         var _loc5_:Number = _loc8_ + param1.speed.x * _loc10_;
         var _loc4_:Number = _loc6_ + param1.speed.y * _loc10_;

package core.states.AIStates
{
   ...
   public class AIObserve implements IState
   {
      ...
      public function enter() : void
      {
         ...
         {
         MessageLog.write(s.name + " STARTED Observe, speed =" + Math.sqrt(Math.pow(s.course.speed.x, 2) + Math.pow(s.course.speed.y, 2)) + "px / sec");
         }
      }
      ...
      {
         var _loc3_:Number = s.pos.x - param1.pos.x;
         var _loc2_:Number = s.pos.y - param1.pos.y;

package core.unit
{
   ...
   public class Unit extends GameObject
   {
      ...
      private function updateIsNear() : void
      {
         ...
         nextDistanceCalculation = _loc2_ / (10 * Game.fps) * 100;
      ...
      public function canBeDamage(param1:Unit, param2:Projectile) : Boolean
      {
         ...
         if(param2.isHeal)
         {
            ...
            if(param1 is PlayerShip && _loc10_ is PlayerShip)
            {
               return true;
            }
            _loc3_ = int(_loc10_.factions.length);
            _loc6_ = int(param1.factions.length);
            var _loc8_:String = "";
            _loc4_ = 0;
            while(_loc4_ < _loc3_)
            {
         ...
         if(!_loc10_.alive || _loc10_.invulnerable || !_loc10_.isHostile && !param1.isHostile || param1.group != null && _loc10_.group != null && (param1.group.id == _loc10_.group.id && !g.solarSystem.isPvpSystemInEditor))
         {
            return false;
         }
      ...
      public function doDOTEffect(param1:int, param2:String, param3:int = -1, param4:String = "") : void
      {
         ...
         if(param3 == 12)
         {
            ...
            if(!(this is PlayerShip))
            {
               ...
               {
                  slowDown = 0.5;
                  slowDownEndtime = g.time + param1 * 1000;
               }
            }
         }
         ...
         else
         {
            ...
            _loc8_ = EmitterFactory.create(param2,g,pos.x,pos.y,this,true);

package core.states.AIStates
{
   ...
   public class AIOrbit implements IState
   {
      ...
      private static const TICK_LENGTH_W:Number = 33;
      ...
      public function enter() : void
      {
         ...
         {
         MessageLog.write(s.name + " STARTED Orbit, speed =" + Math.sqrt(Math.pow(s.course.speed.x, 2) + Math.pow(s.course.speed.y, 2)) + "px / sec");
         }
         s.target = null;

package core.states.gameStates
{
   ...
   public class PlayState extends GameState
   {
      ...
      public function PlayState(param1:Game)
      {
         ...
         this.blackBackground = new Quad(10,10,0);
         super(param1);
      ...
      private function checkZoom() : void
      {
         ...
         {
            g.zoomFactor *= 0.98;
            g.camera.zoomFocus(1 * g.zoomFactor,4);
         }
      ...
      public function checkAccelerate(param1:Boolean = false) : void
      {
         ...
         if((!_loc3_.accelerate || _loc2_.boostEndedLastTick) && !param1 && !_loc2_.usingBoost && keybinds.isInputDown(11) || !_loc3_.accelerate && autoCruise)
         {
            _loc2_.boostEndedLastTick = false;
            sendCommand(0,true);
            g.camera.zoomFocus(0.85 * g.zoomFactor,100);
         }
         if((_loc3_.accelerate || _loc2_.boostEndedLastTick) && !_loc2_.usingBoost && keybinds.isInputUp(11) && !autoCruise)
         {
            _loc2_.boostEndedLastTick = false;
            sendCommand(0,false);
            g.camera.zoomFocus(1 * g.zoomFactor,100);
         }
         if(!_loc3_.accelerate && !_loc3_.deaccelerate && !param1 && !_loc2_.usingBoost && keybinds.isInputDown(12))
         {
            sendCommand(8,true);
            g.camera.zoomFocus(1 * g.zoomFactor,100);
         }
      ...
      private function checkBoost() : void
      {
         if(keybinds.isInputPressed(15))
         {
            ...
            {
               g.camera.zoomFocus(0.75 * g.zoomFactor,100);
            }
         }
      }

package core.boss
{
   ...
   public class Boss extends GameObject
   {
      ...
      public function Boss(param1:Game)
      {
         ...
         this.factions = new Vector.<String>();
         super();
      ...
      private function updateIsNear() : void
      {
         ...
         if(distanceToCamera * g.zoomFactor < _loc2_)
         {
            if(isAddedToCanvas)
            {
               return;
      ...
      public function updateHeading(param1:Heading) : void
      {
         ...
         if(angleTargetPos != null)
         {
            ...
            else
            {
               ...
               {
                  param1.rotation = Util.clampRadians(_loc10_);
               }
            }
         }
         if(param1.accelerate)
         {
            ...
            else
            {
               ...
               param1.speed.x = _loc8_;
               param1.speed.y = _loc7_;
            }
         }

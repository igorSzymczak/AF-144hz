package core.ship
{
   ...
   public class EnemyShip extends Ship
   {
      ...
      {
         this.aiHardenedShieldEffect = new Vector.<Emitter>();
         this.weaponRanges = new Vector.<WeaponRange>();
         this.chargeEffect = new Vector.<Emitter>();
         this.rareEmitters = new Vector.<Emitter>();

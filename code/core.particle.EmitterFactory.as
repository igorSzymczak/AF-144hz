package core.particle
{
   ...
   public class EmitterFactory
   {
      ...
      public static function create(param1:String, param2:Game, param3:int = 0, param4:int = 0, param5:GameObject = null, param6:Boolean = false, param7:Boolean = true, param8:Boolean = true, param9:Sprite = null, forceFixedEmission:Boolean = false) : Vector.<Emitter>
      {
         var delay:Number;
         ...
         if(!g.isLeaving && effectObj != null)
         {
            ...
            for each(obj in effectObj.emitters)
            {
               ...
               e.posX = x;
               e.posY = y;
               e.forceFixedEmission = forceFixedEmission;
      ...
      private static function resolveTexture(param1:Object, param2:GameObject = null) : Texture
      {
         ...
         return _loc4_.getTextureMainByKey(param1.bitmap);
      }

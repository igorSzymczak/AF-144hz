package core.states.player
{
   ...
   public class Killed implements IState
   {
      ...
      {
         this.upperScaleLimit = 1.1;
         this.lowerScaleLimit = 0.9;
         this.limitIterator = 0.02;
         super();
         this.player = param1;
         this.g = param2;
         this.m = param3;
      ...
      public function execute() : void
      {
         ...
         if(player.isMe)
         {
            ...
            uberText.scaleX += limitIterator / Game.bdt;
            uberText.scaleY += limitIterator / Game.bdt;
            respawnText.scaleX += limitIterator / Game.bdt;
            respawnText.scaleY += limitIterator / Game.bdt;
         }
      }
